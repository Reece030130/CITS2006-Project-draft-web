		...
		<div class="container">
		  <div class="header_top">
			<ul class="phone">
				...
				<li class="phone_right">Welcome to the ordering system</li>
			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav menu1">
										<li><a href="Main.jsp" class="active">Main Page</a></li>
										<li><a href="orders.jsp">Online ordering</a></li>
										<li><a href="#">Ordering help</a></li>
										<li><a href="#">Customer Service</a></li>
										<li><a href="contact.html">Contact us</a></li>
									</ul>
		          <ul class="login">
		          	<a href="login.jsp"><li class="login_top"><i class="sign"> </i><span>Log in</span></li></a>
		            <a href="register.jsp"><li class="login_bottom"><i class="register"> </i><span>Sign up</span></li></a>
		          </ul>
			      <div class="clearfix"></div>
			    </div><!-- /.navbar-collapse -->
			  </div><!-- /.container-fluid -->
		     ...
		     <div class="col-md-9">
	          ...
	          <div class="account_grid">
			   ...
			   <div class="col-md-6 login-right" style="margin-left: 25%;height: 270px;">
				  ...
				  <div>
					<span style="margin: 20px 0 5px 3px;">Username<label>*</label></span>
					<input type="text" name="u_name" id="u_name">
				  </div>
				  <div>
					<span style="margin: 20px 0 5px 3px;" >Password<label>*</label></span>
					<input type="text" name="u_pwd" id="u_pwd">
				  </div>
				  
				  <div style="margin: 20px 0 0 3px;">
				  <input style="float: left;" type="checkbox" value="7"/><span style="float: left;">auto login</span>
				  <input style="float:right;margin-right:25px;    padding: 3px 30px;font-size: 16px;" type="submit" value="Log in">
				  	</div>
				</form>
			   </div>	
			   <div class="clearfix"> </div>
