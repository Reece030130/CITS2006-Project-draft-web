			...
			<div class="container">
				<div class="header_top">
					<ul class="phone">
						...
						<li class="phone_right">asdafwafasf</li>
						<div class="clearfix"></div>
					</ul>

					<ul class="account" style="margin-left:680px;">
						<li><a href="myorders.html">sadfawa</a></li>
					</ul>
					<ul class="shopping_cart" style="margin-left:5px;margin-top:-3px;">
						<a href="#">
							<li class="shop_left"><i class="cart"> </i><span>fgqiwhvawsd</span></li>
						</a>
						<div class="clearfix"> </div>
					</ul>
					<div class="clearfix"></div>
			        ...
			        <span class="icon-bar"></span>
								...
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									<ul class="nav navbar-nav menu1">
										<li><a href="Main.jsp" class="active">aksfhvaouwrfqw</a></li>
										<li><a href="orders.jsp">awvrkao;rba</a></li>
										<li><a href="#">rfhtdrhder</a></li>
										<li><a href="#">wbrsersdf</a></li>
										<li><a href="contact.html">sfsef</a></li>
									</ul>
									<ul class="login">
										<a href="login.jsp">
											<li class="login_top"><i class="sign"> </i><span>sdfsdf</span></li>
										</a>
										<a href="register.jsp">
											<li class="login_bottom"><i class="register"> </i><span>dfebts</span></li>
										</a>
									</ul>
									<div class="clearfix"></div>
								</div>
					...
					<div class="row content">
						<div class="col-md-9">
							...
							<div class="single_right" style="margin-top: 40px;">
								<span style="font-size: 22px;color: #6b6b6b;">name </span>
								<p class="m_5">${requestScope.menu.mname}</p>
								<div class="price_single" style="float: left;width: 200px;">
									<span style="font-size: 22px;color: #6b6b6b;">price</span>
